...
@section('content')
    <div class="container-fluid">
        <div class="col-12">
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center justify-content-between breadcrumb-content">
                        <h5>Tambah Transaksi Penjualan</h5>
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form id="createForm" action="{{ url('/api/penjualan/create') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="penjualanKode">No. Penjualan</label>
                                    <input type="text" id="penjualanKode" name="penjualan_no" placeholder="(Otomatis)" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="penjualanNama">Pelanggan</label>
                                    <input type="text" id="penjualanNama" name="penjualan_pelanggan" class="form-control" value="Pelanggan Umum">
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        ...
        function submitForm() {
            ...
            var formData = {
                penjualan_no: document.getElementById('penjualanKode').value,
                penjualan_tanggal: document.getElementById('penjualanTanggal').value,
                penjualan_pelanggan: document.getElementById('penjualanNama').value,
