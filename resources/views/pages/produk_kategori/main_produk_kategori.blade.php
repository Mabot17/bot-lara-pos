    ...
    <div class="col-md-12">
        <div class="card shadow d-flex">
            <div class="card-body d-flex justify-content-between align-items-center">
                <h2 class="mb-2 page-title">Data Produk Kategori</h2>
                <div class="d-flex align-items-center">
                    ...
                    <!-- Tombol Tambah Data -->
                    <a class="btn btn-primary ms-2" href="{{ route('produkKategori.tambah') }}">
        ...
        <div class="row my-4">
            ...
            <div class="col-md-12">
                <div class="card shadow">
                    <div class="card-body">
                        <!-- table -->
                        <table class="table datatables" id="dataTable-produk_kategori">
                            <thead>
                                <tr>
                                    <th>Kategori ID</th>
                                    <th>Kategori Kode</th>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: '/api/produkKategori/list', // URL endpoint POST
            ...
            success: function(response) {
                ...
                $('#dataTable-produk_kategori').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'kategori_nama' },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                var editUrl = "{{ url('/produkKategori/ubah') }}/" + full.kategori_id;
                                return `
                                    <a href="${editUrl}" class="btn btn-sm btn-info me-2"><i class="fe fe-edit"></i></a>
                                    <button type="button" class="btn btn-sm btn-danger" onclick="konfirmasiHapusProdukKategori('${token}', '${full.kategori_id}', '${full.kategori_kode}', '${full.kategori_nama}')"><i class="fe fe-trash-2"></i></button>
                                `;
                            }
                        }
                    ]
    ...
    function konfirmasiHapusProdukKategori(token, kategori_id, kategori_kode, kategori_nama) {
        ...
        $('#confirmDeleteKategori').on('click', function() {
            $.ajax({
                url: `/api/produkKategori/delete/${kategori_id}`, // Sesuaikan dengan endpoint delete
                method: 'DELETE',
                headers: {
                    'Authorization': 'Bearer ' + token
                },
    ...
    function kategoriCetakPDF(type) {
        ...
        let api_url = null;
        if (type == 'xls-list') {
            api_url = "/api/produkKategori/cetak-list-xls";
        }else{
            api_url = "/api/produkKategori/cetak-list-pdf";
        }
